...
const testimonials = [
  {
    id: 1,
    name: "Pedro Silva",
    designation: "Estudante de Ciência da Computação, 23 anos",
    company: "Inteli",
    testimonial:
      "Meus pais nunca me ensinaram sobre dinheiro, mas o Dalio AI preencheu essa lacuna! " +
      "Aprendi sobre CDB, Tesouro Direto e até ações. Agora me sinto preparado para o futuro financeiro.",
    avatar: "https://randomuser.me/api/portraits/women/4.jpg",
  },
  {
    id: 2,
    name: "Leandro Oliveira",
    designation: "Programador, 23 anos",
    company: "Remoto",
    testimonial:
      "A melhor coisa que fiz foi usar o Dalio AI! Em 3 meses, organizei toda minha vida financeira. " +
      "Agora invisto 30% da minha renda e ainda sobra para curtir. A educação financeira vale ouro!",
    avatar: "https://randomuser.me/api/portraits/men/5.jpg",
  },
  {
    id: 3,
    name: "Felipe Sampaio",
    designation: "Estudante, 22 anos",
    company: "Mercado financeiro",
    testimonial:
      "Mesmo trabalhando no mercado financeiro, aprendi muito com o agente! Ele me ajudou a aplicar na prática " +
      "conceitos que eu só conhecia na teoria. Minha carteira de investimentos nunca esteve tão diversificada.",
...
const Testimonial = () => {
  ...
  return (
    ...
    >
      <h2 className="mb-6 text-4xl md:text-5xl font-bold text-center tracking-tight">
        Histórias de Sucesso
      </h2>
      <p className="text-center text-muted-foreground mb-8 max-w-2xl mx-auto">
        Veja como jovens brasileiros transformaram suas vidas financeiras com o Dalio AI
      </p>
          ...
          {Array.from({ length: count }).map((_, index) => (
            <button
              ...
              className={cn("h-3.5 w-3.5 rounded-full border-2 transition-colors", {
                "bg-[#6a8fdb] border-[#6a8fdb]": current === index + 1,
                "bg-transparent border-gray-300 hover:border-[#6a8fdb]": current !== index + 1,
              })}
            />
          ))}
        </div>
...
const TestimonialCard = ({
  ...
  <div className="mb-8 bg-accent rounded-xl py-8 px-6 sm:py-6">
    <div className="flex items-center justify-between gap-20">
      <div className="hidden lg:block relative shrink-0 aspect-[3/4] max-w-[18rem] w-full bg-gradient-to-br from-[#d1f1ff] to-[#b7d9f6] rounded-xl">
        <div className="absolute inset-0 bg-gradient-to-br from-[#9ec0ed]/20 to-[#6a8fdb]/20 rounded-xl" />
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-6xl">💰</div>
        </div>

        <div className="absolute top-1/4 right-0 translate-x-1/2 h-12 w-12 bg-[#6a8fdb] rounded-full flex items-center justify-center">
          <svg
            width="102"
            height="102"
            viewBox="0 0 102 102"
        ...
        <div className="flex items-center justify-between gap-1">
          <div className="hidden sm:flex md:hidden items-center gap-4">
            <Avatar className="w-8 h-8 md:w-10 md:h-10">
              <AvatarFallback className="text-xl font-medium bg-[#6a8fdb] text-white">
